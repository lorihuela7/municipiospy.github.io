...
function iniciarMap()
{
    //Ejemplo - Localizacion de ALTO PARAGUAY
    //PRUEBA EN DURO.
    ...
    var marker = new google.maps.Marker({position: coord, map: map, title: 'ALTO PARAGUAY', url: 'recursos.html' });
    
    //Escuchador: Evento Click
    google.maps.event.addListener(marker, 'click', function () { window.location = marker.url; });    
    
    //Consultando y ubicando Marcadores de Establecimientos Educativos
    //WEB SERVICE: http://datos.mec.gov.py/data/establecimientos_2012.json
    //Se utiliza archivo descargado del web service - establecimientos.json
...
//UBICA LOS MARCADORES EL EL MAPA
